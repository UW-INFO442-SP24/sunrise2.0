        ...
        <div className="row">
          <div className="col text-content">
            <p className="HomePage-paragraph">
              <br />
              <b className='subtitle'>Welcome to Healthlete! <br /> </b>
              <br />
              <p>Your ultimate destination for volleyball rehabilitation and exercise solutions! <br />
                ...
                Our comprehensive approach combines <b><i>Resources</i></b>, <br />
                <b><i>Body diagram</i></b>, and <b><i>Quiz</i></b> to help you know your body better, <br />
